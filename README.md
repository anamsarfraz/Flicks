...
- [x] Made the search bar respond to beginEditing event by popping up the keyboard.
- [x] Added a tap gesture recognizer to hide keyboard when user taps outside.
